  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 gap-4 select-none">
      <div className="relative w-24 h-24">
        ...
        <svg
          className="w-full h-full animate-[spin_2.5s_linear_infinite]"
          viewBox="0 0 100 100"
          fill="none"
      ...
      <p className="text-sm font-medium text-violet-500 animate-pulse font-sans">
        Мурчим и загружаем... Мяу! 🐾
      </p>
    </div>
  )
}
...
export function SleepingCat({ className = "w-6 h-6" }: { className?: string }) {
  return (
    ...
    >
      ...
      <path
        d="M 70 51 Q 72.5 53 72.5 51 Q 72.5 53 75 51"
        stroke="#1E293B"
        strokeWidth="1.5"
        strokeLinecap="round"
        fill="none"
      ...
      {/* Tail curled around */}
      <path
        d="M 22 66 Q 12 50 12 35 Q 12 22 22 22"
        stroke="#94A3B8"
        strokeWidth="9"
        strokeLinecap="round"
        fill="none"
...
export function ActiveCat({ className = "w-6 h-6" }: { className?: string }) {
  return (
    ...
    >
      ...
      <path
        d="M 46 40 Q 50 42.5 50 40 Q 50 42.5 54 40"
        stroke="#1E293B"
        strokeWidth="2"
        strokeLinecap="round"
        fill="none"
      ...
      {/* Whiskers */}
      <path
        d="M 34 38 L 22 36 M 34 41 L 20 41 M 34 44 L 22 46"
        stroke="#FEF3C7"
        strokeWidth="2"
        strokeLinecap="round"
      />
      <path
        d="M 66 38 L 78 36 M 66 41 L 80 41 M 66 44 L 78 46"
        stroke="#FEF3C7"
        strokeWidth="2"
        strokeLinecap="round"
      />
      {/* Upright happy tail */}
      <path
        d="M 68 76 Q 88 74 82 46 Q 78 30 84 20"
        stroke="#F59E0B"
        strokeWidth="7"
        strokeLinecap="round"
        fill="none"
      ...
      {/* Electric Sparks */}
      <path
        d="M 12 18 L 8 26 L 14 26 L 10 36 L 20 24 L 14 24 Z"
        fill="#F59E0B"
        className="animate-pulse"
      />
      <path
        d="M 88 18 L 84 26 L 90 26 L 86 36 L 96 24 L 90 24 Z"
        fill="#F59E0B"
        className="animate-pulse"
      />
    </svg>
...
export function EmptyCat({ className = "w-32 h-32" }: { className?: string }) {
  return (
    <svg
      className={`${className} select-none animate-fade-in`}
      viewBox="0 0 120 120"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
      ...
      <path
        d="M 25 25 C 20 20, 10 35, 20 45 C 10 50, 25 65, 35 55 C 45 65, 60 50, 50 40 C 60 30, 40 10, 25 25 Z"
        fill="#E2E8F0"
        opacity="0.6"
        stroke="#94A3B8"
        strokeWidth="2"
        strokeDasharray="3 3"
      />
      <text x="28" y="44" fill="#64748B" fontSize="16" fontWeight="bold" fontFamily="monospace">
        ?
      </text>
